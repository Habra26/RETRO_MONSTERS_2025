...
<section class="w-full">
    <section class="mb-20">
        <div class="bg-gray-700 rounded-lg shadow-lg monster-card" data-monster-type="<?php echo $monster['type_name']; ?>">
            <div class="md:flex">
                <!-- Image du monstre -->
                <div class="w-full md:w-1/2 relative">
                    <img class="w-full h-full object-cover rounded-t-lg md:rounded-l-lg md:rounded-t-none"
                        src="../public/images/<?php echo $monster['image_url']; ?>" alt="<?php echo $monster['name']; ?>" />
                ...
                <div class="p-6 md:w-1/2">
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            ...
                            <span class="text-gray-300"><?php echo $monster['rarity']; ?></span>
                        </div>
                        <div>
                            <strong class="text-white">Date d'ajout:</strong>
                            <span class="text-gray-300"><?php echo $monster['created_at']; ?></span>
                        </div>
                    </div>
                    <div class="mb-4">
    ...
    <div class="mt-6">
        ...
        <div class="bg-gray-800 rounded p-4">
            ...
            <textarea class="w-full p-2 bg-gray-900 rounded text-gray-300" rows="4"
