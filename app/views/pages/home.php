        ...
        <div class="md:flex">
            ...
            <div class="w-full md:w-1/2 relative">
                <img class="w-full h-full object-cover rounded-t-lg md:rounded-l-lg md:rounded-t-none"
                    src="<?php echo $randomMonster['image_url']; ?>" alt="<?php echo $randomMonster['image_url']; ?>" />
...
<section class="mb-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <article
            ...
            <img class="w-full h-48 object-cover rounded-t-lg" src="<?php echo $monster['image_url']; ?>" alt="<?php echo $monster['image_url']; ?>" />
            <div class="p-4">
